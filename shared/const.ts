...
// HTTP localhost cannot accept a `__Host-` cookie because that prefix mandates
// `Secure`. The local name is deliberately host-only as no Domain is supplied.
export const LOCAL_OAUTH_STATE_COOKIE = "oauth_state";
