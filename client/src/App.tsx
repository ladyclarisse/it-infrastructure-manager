...
function Router() {
  return <DashboardLayout><Switch><Route path="/" component={Home} /><Route path="/users" component={UsersPage} /><Route path="/roles" component={RolesPage} /><Route path="/audit" component={AuditPage} /><Route path="/infrastructure" component={InfrastructurePage} /><Route path="/monitoring"><PlannedPage title="Monitoring" description="Les métriques réelles seront connectées avec un agent/exporter et un moteur de collecte." /></Route><Route path="/backups"><PlannedPage title="Sauvegardes" description="Le suivi des jobs de sauvegarde sera ajouté après définition du connecteur de collecte." /></Route><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch></DashboardLayout>;
}
